...
// 課題番号51P_6
console.log(
  "ーーーーーーーーーーーーーーーーー【50p 2】ジャンケン１０回の履歴出力 " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
...
console.log(
  "ーーーーーーーーーーーーーーーーー【50p 3】ジャンケン１０回の履歴出力 " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
...
console.log(
  "ーーーーーーーーーーーーーーーーーーーーーーーー【50p 4】ジャンケン１０回の履歴出力",
);
...
console.log(
  "ーーーーーーーーーーーーーーーーーーーーーーーー【50p 4 別解】ジャンケン１０回の履歴出力",
);
...
// ==========================================
console.log(
  "ーーーーーーーーーーーーーーーーーーーーーーーー【50p 5 別解】ジャンケン１０回の履歴出力",
);
...
console.log(
  "ーーーーーーーーーーーーーーーーーーーーーーーー【50p 5 別解】４番で出力したランダムな数値を昇順にする",
);
...
// 課題番号51P5t（別解）
console.log(
  "ーーーーーーーーーーーーーーーーー【51P_5別解】上記で出力した昇順の配列を降順にする_51P_6 " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
...
// 課題番号51P_6（別解）
console.log(
  "ーーーーーーーーーーーーーーーーー【51P_6別解】上記で出力した昇順の配列を降順にする_51P_6 " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
...
// 課題番号51P_5-------------------------------------------------------
console.log(
  "★★昇順★★ーーーーーーーーーーーーーーーーー【51-５別解】数値と配列を渡すと、昇順でソートして配列を返す " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
...
// 課題番号51P_５-------------------------------------------------------
console.log(
  "ーーーーーーーーーーーーーーーーー【51-５別解】数値と配列を渡すと、昇順でソートして配列を返す " +
    "\n" +
    "ーーーーーーーーーーーーーーーーー-",
);
